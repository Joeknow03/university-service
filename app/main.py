...
from app.api.universities import universities
...
app = FastAPI(openapi_url="/api/v1/universities/openapi.json", docs_url="/api/v1/universities/docs")


KEYCLOAK_URL = "http://keycloak:8080/"
KEYCLOAK_CLIENT_ID = "testClient"
KEYCLOAK_REALM = "testRealm"
KEYCLOAK_CLIENT_SECRET = "UK36GGPzRQKMYiZnTtxA24YiuaT5wTlY"
...
app.include_router(universities, prefix='/api/v1/universities', tags=['universities'])